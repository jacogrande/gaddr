---
name: design-kit
description: Generate and evaluate multiple design kits using a genetic algorithm approach. Creates 6 competing design kits with Tailwind, runs a tournament evaluation with screenshots, and synthesizes the best elements into a final design system.
argument-hint: [aesthetic direction or keywords]
disable-model-invocation: true
allowed-tools: Read, Write, Edit, Glob, Grep, Bash(bun *), Bash(bunx *), Bash(ls *), Bash(mkdir *), Task
---
