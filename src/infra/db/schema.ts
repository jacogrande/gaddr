...
export const essay = pgTable(
  ...
  (t) => [index("essay_user_id_idx").on(t.userId)],
);
...
export const evidenceCard = pgTable(
  "evidence_card",
  {
    id: text("id").primaryKey(),
    userId: text("user_id")
  ...
  (t) => [index("evidence_card_user_id_idx").on(t.userId)],
);

export const claimEvidenceLink = pgTable(
  "claim_evidence_link",
  {
    id: text("id").primaryKey(),
    essayId: text("essay_id")
  ...
  (t) => [
    index("claim_evidence_link_essay_id_idx").on(t.essayId),
    index("claim_evidence_link_evidence_card_id_idx").on(t.evidenceCardId),
  ],
);
